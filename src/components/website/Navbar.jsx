...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-white/70 dark:bg-slate-900/75 backdrop-blur-md shadow-sm border-b border-white/40 dark:border-slate-800/60 ${
        scrolled ? "py-2.5 shadow-md bg-white/85 dark:bg-slate-900/90" : "py-3.5"
      }`}
    >
