...
export default function ClassesOffering() {
  ...
  return (
    <section
      id="classes"
      className="py-20 bg-gradient-to-br from-slate-100/60 via-primary-light/10 to-transparent dark:from-background dark:via-primary-dark/5 dark:to-transparent"
    >
